...
public final class GatewayDrownedHandler {
    ...
    private static final String GATEWAY_DROWNED_KEY = "gatewayexpansion.gateway_drowned";
    private static final String AI_PATCHED_KEY = "gatewayexpansion.gateway_drowned_ai_patched";
