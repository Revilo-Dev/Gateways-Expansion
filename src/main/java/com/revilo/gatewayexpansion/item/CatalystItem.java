...
public class CatalystItem extends Item {
    ...
    private static void appendPositiveEffectTooltip(List<Component> tooltipComponents, ForgeEffect effect) {
        if (effect.type() != ForgeEffectType.EXTRA_RARE_REWARD_ROLLS) {
            tooltipComponents.add(Component.translatable("tooltip.gatewayexpansion.catalyst.positive", effect.description()).withStyle(ChatFormatting.GREEN));
            return;
        }
        ...
        tooltipComponents.add(Component.translatable("tooltip.gatewayexpansion.catalyst.positive", "+" + rareRewards + " rare rewards").withStyle(ChatFormatting.GREEN));
        tooltipComponents.add(Component.translatable("tooltip.gatewayexpansion.catalyst.positive", "+" + epicRewards + " epic rewards").withStyle(ChatFormatting.GREEN));
        if (effect.description().contains("+1 legendary reward")) {
            tooltipComponents.add(Component.translatable("tooltip.gatewayexpansion.catalyst.positive", "+1 legendary reward").withStyle(ChatFormatting.GREEN));
        }
    }
